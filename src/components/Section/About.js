...
const About = () => (
    <Section sectionTitle="About Me">
        <h4 className="text-center">Hi, I'm Daniel! This personal site is a chance for me to carve out a personal space of the web
            and share my accomplishments and what I'm up to.</h4>
        <p className="text-center">I’m a hardworking <span className="highlight">computer science senior</span> at Stevens Institute of Technology, determined to constantly learn and have new experiences. </p>
