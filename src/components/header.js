              ...
              <div className="header-buttons">
                <a href="https://www.linkedin.com/in/iwanttohiredanielkramer/">
                  <button type="button" className="btn btn-lg btn-daniel">
                    ...
                    {` `}
                    <span className="d-none d-xl-inline-flex">Linkedin</span>
                  </button>
                </a>

                <a href="https://www.github.com/codankra">
                  <button type="button" className="btn btn-lg btn-daniel">
                    <FaGithub className="fanav" />
                    {` `}
                    <span className="d-none d-xl-inline-flex">Github</span>
                  </button>
                </a>
                <a
                ...
                >
                  <button type="button" className="btn btn-lg btn-daniel">
                    <FaFileAlt />
                    {` `}
                    <span className="d-none d-xl-inline-flex">Resume</span>
                  </button>
                </a>
                <a href="mailto:codankra@gmail.com">
                  <button type="button" className="btn btn-lg btn-daniel">
                    <FaEnvelope className="fanav" />
                    {` `}
                    <span className="d-none d-xl-inline-flex">Email</span>
                  </button>
                </a>
              </div>
            </div>
